...
async function sunoCommand(sock, chatId, message) {
    try {
        ...
        const prompt = query;
        const style = 'Villain'; // ✅ Style changed to Villain
        const title = 'Raza AI Song';

        // ✅ Same API key for both create + status
                    ...
                    await sock.sendMessage(chatId, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: '',
                                thumbnail: imageUrl
                                    ? await (await axios.get(imageUrl, { responseType: 'arraybuffer' })).data
                                    : null,
